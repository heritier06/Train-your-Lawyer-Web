    ...
    <div className="Register">
            ...
            <div className="formulaire">
                <form action="/">
                    ...
                    <li>
                        <Link to="/" className="account">Créer un compte</Link>
                    </li>
                    ...
                    <input type="password" name="confirm" id="pass" placeholder="Confirmer le mot de passe" required></input>
                    <a class="number" href='#'>1/2</a>
                    <a class="button" href="/Register2">Suivant</a>
