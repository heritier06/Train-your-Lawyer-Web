        ...
        <div className="formulaire">
            <form action="/" @submit.prevent="createPost">
              ...
              <div v-if="inactive">
                ...
                <input type="name" name="nom" id="nom" placeholder="Nom" v-model="nom" required autofocus />
                <input type="name" name="prenom" id="nom" placeholder="Prénom" v-model="prenom" required autofocus/>
                <a class="number" href='#' @click="nextPage">2/2</a>
