<template>
    <div class="h-screen Lesson">
        ...
        <div class="grid grid-flow-row-dense grid-cols-1 grid-rows-3 content">
            <button class="first-training"  @click="$router.push('/Penalent')">
                <div class="brd-1">
            ...
            <button class="second-training" @click="$router.push('/Register1')">
                <div class="brd-2">
            ...
            <button class="third-training" @click="$router.push('/Register1')">
                <div class="brd-3">
